...
client.on("guildCreate", guild => {
  // This event triggers when the bot joins a guild.
	...
	const ADMIN_CHANNEL = client.channels.get("405792135233798186","376472607714836490"); 
...
**Now playing:** ${serverQueue.songs[0].title}
		...
		msg.channel.send('hi');
		msg.channel.send('<:eeeh:404312550554206208> ');
		}
									}
...
function play(guild, song) {
	...
	serverQueue.textChannel.send('<a:MUSIC:467809933887275008> '+`🎶 Start playing: **${song.title}** 🎶`+'<a:MUSIC:467809933887275008> ');
}
